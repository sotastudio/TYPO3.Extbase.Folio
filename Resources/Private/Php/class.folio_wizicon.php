...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/folio/Resources/Private/Php/class.folio_wizicon.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/folio/Resources/Private/Php/class.folio_wizicon.php']);
}
?>